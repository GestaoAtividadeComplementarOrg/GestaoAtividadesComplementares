...
public final class MensagemNotificacaoFactory {
	...
	public static MensagemNotificacao criar(String status, String justificativa) {
		if (status == null) {
		...
		return switch (status) {
			...
			default -> throw new IllegalArgumentException("Status desconhecido para notificação: " + status);
		};
	}
}
